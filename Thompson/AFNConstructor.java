...
public class AFNConstructor<T> {
    ...
    public AFNConstructor(String regex) {
        this.regex = regex;
    ...
    public Automata cerraduraKleene(Automata automataFN)
    {
        ...
        nuevoInicio.getTransiciones().add(new Transicion(nuevoInicio, anteriorInicio, 'E'));
        nuevoInicio.getTransiciones().add(new Transicion(nuevoInicio, nuevoFin, 'E'));
        
        // agregar transiciones desde el anterior estado final
        for (int i =0; i<anteriorFin.size();i++){
            anteriorFin.get(i).getTransiciones().add(new Transicion(anteriorFin.get(i), anteriorInicio,'E'));
            anteriorFin.get(i).getTransiciones().add(new Transicion(anteriorFin.get(i), nuevoFin, 'E'));
        }
   ...
   public Automata concatenacion(Automata AFN1, Automata AFN2){
       ...
       Automata afn_concat = new Automata();
        ...
        for (int j =0;j<AFN1.getEstados().size()-1;j++){
    ...
    public Automata union(Automata AFN1, Automata AFN2){
        ...
        nuevoInicio.setTransiciones(new Transicion(nuevoInicio,AFN2.getEstadoInicial(),'E'));
        ...
        for (int k =0; k<anteriorFin.size();k++)
            anteriorFin.get(k).getTransiciones().add(new Transicion(anteriorFin.get(k), nuevoFin, 'E'));
         // agregar transiciones desde el anterior AFN 2 al estado final
        for (int k =0; k<anteriorFin.size();k++)
            anteriorFin2.get(k).getTransiciones().add(new Transicion(anteriorFin2.get(k),nuevoFin,'E'));
